...
|----------------------------------------|--------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|
[Exploratory Data Analysis](https://github.com/brifae456/Data-Projects---TripleTen/tree/main/Exploratory%20Data%20Analysis)                                            |Come up with insights on shopping habits of Instacart customers                              |'pandas' 'numpy' 'matplotlib'                                                              |
[Machine Learning- OilyGiant](https://github.com/brifae456/Data-Projects---TripleTen/tree/main/Machine%20Learning-%20Oily%20Giant)               |Working for the OilyGiant mining company. The task is to find the best place for a new well. Using the data on oil samples from three regions. Build a model that will help to pick the region with the highest profit margin. Analyze potential profit and risks using the Bootstrapping technique. | 'numpy' 'pandas' 'scipy' and 'sklearn' |    
...
[Python- TV Show Rating Impact](https://github.com/brifae456/Data-Projects---TripleTen/tree/main/Python-TV%20Show%20Rating%20Impact) |Working in entertainment industry, analyze dataset of records from movies and shows. Determine how votes impact its ratings. | 'pandas'
...
[Statistical Data Analysis- Megaline](https://github.com/brifae456/Data-Projects---TripleTen/tree/main/Statistical%20Data%20Analysis-Megaline). |Performing hypothesis testing to help determine if there is statistically difference in revenue for pre-paid plans  | 'pandas' 'numpy' 'matplotlib' 'scipy'
